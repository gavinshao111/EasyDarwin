/*
export LD_LIBRARY_PATH="/home/panzhao/EasyDarwin/mqtt.c/lib"
g++ MQTTClient_publish.cpp -I ../mqtt.c/include/ -L ../mqtt.c/lib -lpaho-mqtt3c -DNO_PERSISTENCE=1 -o publish
*/
#include "stdio.h"
#include "stdlib.h"
#include "string.h"
...
#define CLIENTID    "mqtt.c_MQTTClient_subscribe"
#define TOPIC       "/carleapmotorCLOUDE20160727inform/videoinfoAsk"
#define PAYLOAD     "Hello World!"
#define QOS         1
#define TIMEOUT     10000L


//from Y:\mqtt_client\mqtt.c.sourceCode\paho.mqtt.c\src\MQTTClientPersistence.h
/**
